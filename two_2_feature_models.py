...
#model= RandomForestClassifier( n_estimators=100,random_state=169, max_depth=2, max_features=2)    
...
#model= RandomForestClassifier( n_estimators=100,random_state=169, max_depth=2, max_features=2,  class_weight='balanced' )   
#model = xgb.XGBClassifier(booster='gbtree', 
    # objective='binary:logistic',
    #           use_label_encoder=False, 
    #           eval_metric='error',
...
#odel= RandomForestClassifier( n_estimators=100,random_state=169, max_depth=2, max_features=2, class_weight={0:1, 1:np.sqrt(975/122)})
#model = xgb.XGBClassifier(booster='gbtree', 
    # objective='binary:logistic',
    #           use_label_encoder=False, 
    #           eval_metric='error',
