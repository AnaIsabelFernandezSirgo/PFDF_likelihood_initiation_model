# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 10:39:07 2025
...
# Data * Rain intensity option
#np.load("i10_3.npy")
#np.load("i15_3.npy")
#np.load("i30_3.npy")
#np.load("i60_3.npy")

data_rained= np.load("i15_3.npy")
...
# preallocation 
test=np.zeros((len_test,mk,mc,mp))
train=np.zeros((len_train,mk,mc,mp));
z=np.zeros((975,1));
o=np.ones((122,1));
...
ts_median_index=np.column_stack((ts_sort_median, index_median))
ts = ts_median_index[::-1]
df = pd.DataFrame(ts_median_index)
...
#rf_3_10
#_15 _30 _60 
# #df.to_excel(excel_writer = "D:/Fire_jul24/TS_3_15_lm.xlsx")
